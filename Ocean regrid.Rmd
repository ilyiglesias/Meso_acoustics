...
This code is preceded by "Ocean data.Rmd" and followed by "satellite.Rmd"

# Objective of code:
the following code extracts CTD data for each re-gridded acoustic data cell (25km by 25km). This is different from Ocean data.rmd which processes all of the CTD data (visualizing profiles, smoothing data etc.)
