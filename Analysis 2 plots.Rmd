...
ggplot(data=bathy_xyz)+
  ...
  geom_contour(data=bathy_xyz, aes(x=V1, y=V2, z=V3), breaks = c(-550), color="#0072B2", size=0.5)+ # depth minimum value of 550m
  annotate(geom="text", x=-122.1, y=36, label="550 m", color="#0072B2", size=3)+ #label contour
...
ggplot(data=acoustics_ctd, aes(x=as.factor(year), y=Z, group=year, color=as.factor(year)))+
  ...
  geom_text(data= summary_yrs, aes(x = year, y = median_Z, label = paste0("Median:", round(median_dyn_ht, 2))), size = 3, vjust = -0.5)+ #label
...
ggplot(data=acoustics_ctd, aes(x=as.factor(year), y=temp_cm, group=year, color=as.factor(year)))+
  ...
  scale_color_manual(values = c("2013"="black" , "2014"="black", "2015"="#D55E00" , "2016"= "#D55E00" , "2017"="black", "2018"="black"))+
  geom_jitter(alpha=0.3, color="#999999" , width=0.15)+
  geom_text(data= summary_yrs, aes(x = year, y = median_temp_cm, label = paste0("Median:", round(median_dyn_ht, 2))), size = 3, vjust = -0.5)+ #label
...
ggplot(data=acoustics_ctd, aes(x=as.factor(year), y=MVBS, group=year, color=as.factor(year)))+
  ...
  scale_color_manual(values = c("2013"="black" , "2014"="black", "2015"="#D55E00" , "2016"= "#D55E00" , "2017"="black", "2018"="black"))+
  geom_jitter(alpha=0.3, color="#999999" , width=0.15)+
  geom_text(data= summary_yrs, aes(x = year, y = median_MVBS, label = paste0("Median:", round(median_dyn_ht, 2))), size = 3, vjust = -0.5)+ #label
  xlab("Year")+
  ylab("MVBS [dB]")+
  ggthemes::theme_few()+
  theme(legend.position = 'none')
...
ggplot(data=acoustics_ctd, aes(x=as.factor(year), y=chl_100m, group=year, color=as.factor(year)))+
  ...
  scale_color_manual(values = c("2013"="black" , "2014"="black", "2015"="#D55E00" , "2016"= "#D55E00" , "2017"="black", "2018"="black"))+
  geom_jitter(alpha=0.3, color="#999999" , width=0.15)+
  geom_text(data= summary_yrs, aes(x = year, y = median_chl, label = paste0("Median:", round(median_dyn_ht, 2))), size = 3, vjust = -0.5)+ #label
  xlab("Year")+
...
ggplot(data=acoustics_ctd, aes(x=as.factor(year), y=o2_150m, group=year, color=as.factor(year)))+
  ...
  scale_color_manual(values = c("2013"="black" , "2014"="black", "2015"="#D55E00" , "2016"= "#D55E00" , "2017"="black", "2018"="black"))+
  geom_jitter(alpha=0.3, color="#999999" , width=0.15)+
  geom_text(data= summary_yrs, aes(x = year, y = median_o2_150m, label = paste0("Median:", round(median_dyn_ht, 2))), size = 3, vjust = -0.5)+ #label
  xlab("Year")+
