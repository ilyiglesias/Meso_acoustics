...
while noting that we will need to additionally remove covariates that are concurvity(ed)?
```{r}
...
Of concern: Z and oxygen at 500 m (0.7) and Temperature at 175 m ~ Oxygen at 175 m (0.7)

The following would be the final list: between oxygen and temperature, oxygen makes more sense because there is some evidence that bioligcally limiting
