...
```
NOTE: as this data is still pending review, they are not publically accessible. I will need to update this after acceptance of publication
For more on package {rdryad} see: https://cran.r-project.org/web/packages/rdryad/rdryad.pdf

NOTE: for now, data downloaded from Dryad stored in folder "Data" within working directory
...
Note this is a lot of data (~4.5 million records), so may take awhile
...
For reference, provide a helpful visual for looking at data quality of individual day's of data
